...
public class MutableMbHttpHeader extends AbstractMbHeader implements MbHttpHeader {

    MutableMbHttpHeader(MbElement elm, MbHeaderType type) throws MbException {
        super(elm, type);
    }
