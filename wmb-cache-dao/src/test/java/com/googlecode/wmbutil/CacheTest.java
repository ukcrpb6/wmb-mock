...
import com.googlecode.wmbutil.cache.CacheManager;
import com.googlecode.wmbutil.cache.CacheManagerImpl;
import com.googlecode.wmbutil.cache.HibernateCacheManager;
...
public class CacheTest {
  ...
  public void testCache() throws Exception {
    ...
    HibernateUtil hibernateUtil = new HibernateUtil(getClass().getResource("/src/test/resources/hibernate.cfg.xml"));
